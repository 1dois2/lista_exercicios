...
export default function TelaCadastro({ adicionarItem }) {
  ...
  function salvarDados() {
    ...
    Alert.alert('Sucesso', 'Exercício forjado!');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Forjar Exercício</Text>
      
      <TextInput placeholder='Nome do Exercício' style={styles.input} onChangeText={setNome} value={nome} />
      <TextInput placeholder='Músculo Alvo' style={styles.input} onChangeText={setMusculo} value={musculo} />
      ...
      <Button title='Cadastrar no Arsenal' color='#28a745' onPress={salvarDados} />
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#ccc', padding: 10, marginBottom: 15, borderRadius: 5, fontSize: 16 }
});